...
## Sui blockchain so với các blockchain truyền thống 


**Blockchain truyền thống** 

![](../assets/traditional_blockchain_1.png)


**Blockchain truyền thống thực hiện và verify các giao dịch 1 cách tuần tự** 

![](../assets/traditional_blockchain_2.png)

**Blockchain Sui** 

![](../assets/sui_blockchain.png)


** Sự khác nhau cơ bản **

![](../assets/sui_blockchain_2.png)


## Thành tựu của Sui 

+ All-time High TVL > $1B
+ Total Transactions ~6.5B , ATH Daily Transansactions ~120M, ATH TPS ~1300
+ Total Active Accounts ~25M, Daily Active Accounts ~1M
